...
#define SIGNAL 0x00400000
#define SIGNALLIMIT 0x00000100
#define MEMSHARE 0x00400100
#define MEMSHARELIMIT 0x000FFF00
...
struct semaphore {
	int mutex;
	int cnt;
	struct TASK * waitingstack[10];
	int top;
};


/* exfunc.nas */
unsigned short getldt();
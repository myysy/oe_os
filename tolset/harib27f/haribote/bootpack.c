...
void HariMain(void) {
    ...
    *((int *)0x0fe4) = (int)shtctl;
    ...
    buf_back =
        (unsigned char *)Buddy_alloc_4k(buddy, binfo->scrnx * binfo->scrny);
    ...
    if (finfo != 0) {
        ...
        nihongo =
            (unsigned char *)Buddy_alloc_4k(buddy, 16 * 256 + 32 * 94 * 47);
        for (i = 0; i < 16 * 256; i++) {
    ...
    for (;;) {
        ...
        if (fifo32_status(&fifo) == 0) {
            ...
            if (256 <= i && i <= 511) { /* �L�[�{�[�h�f�[�^ */
                ...
                if (s[0] != 0 &&
                    key_win != 0) { /* �ʏ핶���A�o�b�N�X�y�[�X�AEnter */
